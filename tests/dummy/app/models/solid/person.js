import { VCARD, FOAF, LDP, SP, SOLID } from 'ember-solid-store/utils/namespaces';
import SemanticModel, { property, string, integer, term, solid, rdfType } from 'ember-solid-store/models/semantic-model';
